                ...
                foreach(CheckBox cbx in cbxAnswers)
                {
                    if (cbx.Checked)
                    {
                        ...
                        if (!parent.userAnswers[question.Id].Contains(cbx.Text))
                        {
                            ...
                            parent.stdResult[question.Id].Add(Convert.ToInt32(cbx.Name));
                        }
                    }
                    else
                    {
                        parent.userAnswers[question.Id].Remove(cbx.Text);
                        parent.stdResult[question.Id].Remove(Convert.ToInt32(cbx.Name));
                    }
                }
