...

{
    public partial class AddEditQuestion : Form
    {
        ...
        public List<AnswerControl> AnswerControls { get => answerControls; set => answerControls = value; }
        public bool IsAdd { get => isAdd; set => isAdd = value; }
        public List<Answer> AnswLs { get => answLs; set => answLs = value; }

        public AddEditQuestion(QuestionManagement parent, bool isAdd)
        {
            InitializeComponent();
            ...
            if (!isAdd)
            {
                ...
                txtTime.Value = answLs[0].Q.Time;
                foreach(Answer ans in answLs)
                {
                    AnswerControl ac = new AnswerControl(answerControls.Count + 1,isAdd, this);
