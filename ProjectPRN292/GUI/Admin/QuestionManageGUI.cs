...
{
    public partial class QuestionManageGUI : Form
    {
        public QuestionManageGUI()
        {
            InitializeComponent();
        ...
        private void DgvQuestion_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                AddEditQuestionGUI aq = new AddEditQuestionGUI(this, false);
                aq.ShowDialog();
            }
        }
        ...
        {
            AddEditQuestionGUI aq = new AddEditQuestionGUI(this,true);
            aq.ShowDialog();
        }
    }
}
